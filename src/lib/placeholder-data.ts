...
export const initialSuggestedTasks: Omit<SuggestedTask, 'id'>[] = [
    // CCTV
    { name: 'Fase 1: Planificación y Diseño', category: 'cctv', order: 100 },
    { name: 'Levantamiento en Terreno y Relevamiento de Puntos', category: 'cctv', order: 101 },
    { name: 'Diseño de Ingeniería de Detalle y Planos', category: 'cctv', order: 102 },
    { name: 'Aprobación de Ingeniería por parte del Cliente', category: 'cctv', order: 103 },
    { name: 'Fase 2: Adquisición y Logística', category: 'cctv', order: 200 },
    { name: 'Compra y Adquisición de Equipos (Cámaras, NVR, etc.)', category: 'cctv', order: 201 },
    { name: 'Recepción y Bodegaje de Materiales', category: 'cctv', order: 202 },
    { name: 'Fase 3: Instalación y Montaje', category: 'cctv', order: 300 },
    { name: 'Canalización y Tuberías (Eléctricas / Datos)', category: 'cctv', order: 301 },
    { name: 'Cableado Estructurado (UTP / Fibra Óptica)', category: 'cctv', order: 302 },
    { name: 'Montaje de Gabinete y Equipos Centrales (NVR, Switch)', category: 'cctv', order: 303 },
    { name: 'Montaje Físico de Cámaras y Soportes', category: 'cctv', order: 304 },
    { name: 'Fase 4: Configuración y Puesta en Marcha', category: 'cctv', order: 400 },
    { name: 'Configuración de Red y Direccionamiento IP', category: 'cctv', order: 401 },
    { name: 'Configuración del Software de Gestión de Video (VMS)', category: 'cctv', order: 402 },
    { name: 'Enfoque, Calibración y Pruebas de Cobertura de Cámaras', category: 'cctv', order: 403 },
    { name: 'Pruebas de Grabación y Almacenamiento', category: 'cctv', order: 404 },
    { name: 'Puesta en Marcha Oficial del Sistema', category: 'cctv', order: 405 },
    { name: 'Fase 5: Cierre y Entrega', category: 'cctv', order: 500 },
    { name: 'Capacitación a Usuario Final y Administradores', category: 'cctv', order: 501 },
    { name: 'Elaboración de Documentación y Planos As-Built', category: 'cctv', order: 502 },
    { name: 'Entrega y Recepción Conforme del Proyecto', category: 'cctv', order: 503 },
    
    // CCAA (Control de Acceso)
    { name: 'Fase 1: Planificación y Diseño', category: 'ccaa', order: 100 },
    { name: 'Levantamiento y Definición de Puntos de Control', category: 'ccaa', order: 101 },
    { name: 'Diseño de Topología del Sistema y Ubicación de Equipos', category: 'ccaa', order: 102 },
    { name: 'Fase 2: Adquisición y Logística', category: 'ccaa', order: 200 },
    { name: 'Adquisición de Equipos (Controladoras, Lectoras, Cerraduras)', category: 'ccaa', order: 201 },
    { name: 'Fase 3: Instalación y Montaje', category: 'ccaa', order: 300 },
    { name: 'Instalación de Canalizaciones y Tuberías', category: 'ccaa', order: 301 },
    { name: 'Cableado de Puntos de Control a Controladora', category: 'ccaa', order: 302 },
    { name: 'Instalación de Cerraduras Electromagnéticas / Pestillos Eléctricos', category: 'ccaa', order: 303 },
    { name: 'Montaje de Lectoras y Botones de Salida', category: 'ccaa', order: 304 },
    { name: 'Instalación de Panel de Control (Controladora)', category: 'ccaa', order: 305 },
    { name: 'Fase 4: Configuración y Puesta en Marcha', category: 'ccaa', order: 400 },
    { name: 'Configuración de Software de Control de Acceso', category: 'ccaa', order: 401 },
    { name: 'Creación de Perfiles y Niveles de Acceso', category: 'ccaa', order: 402 },
    { name: 'Registro de Tarjetas/Credenciales de Usuarios', category: 'ccaa', order: 403 },
    { name: 'Pruebas de Apertura, Cierre y Eventos de Puertas', category: 'ccaa', order: 404 },
    { name: 'Integración con otros sistemas (incendio, CCTV)', category: 'ccaa', order: 405 },
    { name: 'Fase 5: Cierre y Entrega', category: 'ccaa', order: 500 },
    { name: 'Marcha Blanca y Ajustes Finales', category: 'ccaa', order: 501 },
    { name: 'Capacitación a Administradores y Usuarios', category: 'ccaa', order: 502 },
    { name: 'Entrega de Documentación y Planos As-Built', category: 'ccaa', order: 503 },
    
    // Detección de Incendios
    { name: 'Fase 1: Ingeniería y Diseño', category: 'detección', order: 100 },
    { name: 'Análisis de Riesgos y Diseño según Normativa (NFPA)', category: 'detección', order: 101 },
    { name: 'Elaboración de Planos y Memoria de Cálculo', category: 'detección', order: 102 },
    { name: 'Aprobación de Planos por Autoridad Competente', category: 'detección', order: 103 },
    { name: 'Fase 2: Adquisición y Logística', category: 'detección', order: 200 },
    { name: 'Adquisición de Paneles, Detectores, Módulos y Sirenas', category: 'detección', order: 201 },
    { name: 'Fase 3: Instalación y Montaje', category: 'detección', order: 300 },
    { name: 'Trazado y Montaje de Tuberías (EMT/PVC)', category: 'detección', order: 301 },
    { name: 'Cableado de Lazos de Detección (Clase A/B)', category: 'detección', order: 302 },
    { name: 'Instalación del Panel Central de Incendios (FACP)', category: 'detección', order: 303 },
    { name: 'Montaje de Detectores de Humo/Temperatura', category: 'detección', order: 304 },
    { name: 'Montaje de Estaciones Manuales', category: 'detección', order: 305 },
    { name: 'Montaje de Sirenas con Estroboscópica', category: 'detección', order: 306 },
    { name: 'Fase 4: Configuración y Pruebas', category: 'detección', order: 400 },
    { name: 'Programación de Zonas y Lógica de Activación en Panel', category: 'detección', order: 401 },
    { name: 'Pruebas de Continuidad y Aislación de Cableado', category: 'detección', order: 402 },
    { name: 'Pruebas Funcionales con Humo/Calor por Dispositivo', category: 'detección', order: 403 },
    { name: 'Prueba de Activación de Sirenas y Luces Estroboscópicas', category: 'detección', order: 404 },
    { name: 'Fase 5: Certificación y Entrega', category: 'detección', order: 500 },
    { name: 'Certificación del Sistema (SEC/NFPA)', category: 'detección', order: 501 },
    { name: 'Capacitación a Personal de Emergencia', category: 'detección', order: 502 },
    { name: 'Entrega de Dossier de Calidad y Planos As-Built', category: 'detección', order: 503 },
    
    // Extinción de Incendios
    { name: 'Fase 1: Ingeniería y Diseño', category: 'extinción', order: 100 },
    { name: 'Ingeniería de Detalle y Cálculo Hidráulico', category: 'extinción', order: 101 },
    { name: 'Selección de Agente Extintor (Agua, gas, etc.)', category: 'extinción', order: 102 },
    { name: 'Fase 2: Adquisición y Logística', category: 'extinción', order: 200 },
    { name: 'Adquisición de Rociadores, Válvulas y Tuberías', category: 'extinción', order: 201 },
    { name: 'Fase 3: Instalación y Montaje', category: 'extinción', order: 300 },
    { name: 'Montaje de Red de Tuberías (Fitting)', category: 'extinción', order: 301 },
    { name: 'Instalación de Rociadores (Sprinklers)', category: 'extinción', order: 302 },
    { name: 'Instalación de Sala de Bombas y Estanque', category: 'extinción', order: 303 },
    { name: 'Conexión a la Red de Agua o Fuente', category: 'extinción', order: 304 },
    { name: 'Fase 4: Pruebas y Puesta en Marcha', category: 'extinción', order: 400 },
    { name: 'Pruebas de Presión y Estanqueidad (Prueba Hidrostática)', category: 'extinción', order: 401 },
    { name: 'Puesta en Marcha del Sistema de Bombeo', category: 'extinción', order: 402 },
    { name: 'Pruebas de Flujo y Descarga de Rociadores', category: 'extinción', order: 403 },
    { name: 'Fase 5: Certificación y Entrega', category: 'extinción', order: 500 },
    { name: 'Certificación de la Instalación', category: 'extinción', order: 501 },
    { name: 'Entrega de Planos y Dossier de Calidad', category: 'extinción', order: 502 },
    
    // Alarma
    { name: 'Fase 1: Planificación y Diseño', category: 'alarma', order: 100 },
    { name: 'Evaluación de Seguridad y Puntos Vulnerables', category: 'alarma', order: 101 },
    { name: 'Diseño del Sistema de Alarma y Zonificación', category: 'alarma', order: 102 },
    { name: 'Fase 2: Adquisición y Logística', category: 'alarma', order: 200 },
    { name: 'Adquisición de Panel, Sensores, Teclados y Sirena', category: 'alarma', order: 201 },
    { name: 'Fase 3: Instalación y Montaje', category: 'alarma', order: 300 },
    { name: 'Cableado de Sensores de Movimiento y Magnéticos', category: 'alarma', order: 301 },
    { name: 'Instalación y Conexión del Panel Central de Alarma', category: 'alarma', order: 302 },
    { name: 'Instalación de Sensores en Puertas y Ventanas', category: 'alarma', order: 303 },
    { name: 'Instalación de Sensores de Movimiento (PIR)', category: 'alarma', order: 304 },
    { name: 'Instalación de Teclado y Sirena', category: 'alarma', order: 305 },
    { name: 'Fase 4: Configuración y Pruebas', category: 'alarma', order: 400 },
    { name: 'Configuración de Zonas, Tiempos de Entrada/Salida', category: 'alarma', order: 401 },
    { name: 'Configuración de Comunicador (GPRS/IP) a Central de Monitoreo', category: 'alarma', order: 402 },
    { name: 'Pruebas de Activación de cada Zona (Walk-test)', category: 'alarma', order: 403 },
    { name: 'Pruebas de Comunicación con Central de Monitoreo', category: 'alarma', order: 404 },
    { name: 'Fase 5: Cierre y Entrega', category: 'alarma', order: 500 },
    { name: 'Capacitación al Usuario sobre Uso, Códigos y Procedimientos', category: 'alarma', order: 501 },
    { name: 'Entrega de Manuales y Contactos de Emergencia', category: 'alarma', order: 502 },
];
