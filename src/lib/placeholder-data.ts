...
export const initialSuggestedTasks: Omit<SuggestedTask, 'id'>[] = [
    ...
    { name: 'Análisis de Riesgos y Diseño según Normativa (NFPA)', category: 'detección', phase: 'Fase 1: Ingeniería y Diseño', order: 101 },
    { name: 'Elaboración de Planos y Memoria de Cálculo', category: 'detección', phase: 'Fase 1: Ingeniería y Diseño', order: 102 },
    { name: 'Aprobación de Planos por Autoridad Competente', category: 'detección', phase: 'Fase 1: Ingeniería y Diseño', order: 103 },
    { name: 'Adquisición de Paneles, Detectores, Módulos y Sirenas', category: 'detección', phase: 'Fase 2: Adquisición y Logística', order: 201 },
    { name: 'Trazado y Montaje de Tuberías (EMT/PVC)', category: 'detección', phase: 'Fase 3: Instalación y Montaje', order: 301 },
    { name: 'Cableado de Lazos de Detección (Clase A/B)', category: 'detección', phase: 'Fase 3: Instalación y Montaje', order: 302 },
    { name: 'Instalación del Panel Central de Incendios (FACP)', category: 'detección', phase: 'Fase 3: Instalación y Montaje', order: 303 },
    { name: 'Montaje de Detectores de Humo/Temperatura', category: 'detección', phase: 'Fase 3: Instalación y Montaje', order: 304 },
    { name: 'Montaje de Estaciones Manuales', category: 'detección', phase: 'Fase 3: Instalación y Montaje', order: 305 },
    { name: 'Montaje de Sirenas con Estroboscópica', category: 'detección', phase: 'Fase 3: Instalación y Montaje', order: 306 },
    { name: 'Programación de Zonas y Lógica de Activación en Panel', category: 'detección', phase: 'Fase 4: Configuración y Pruebas', order: 401 },
    { name: 'Pruebas de Continuidad y Aislación de Cableado', category: 'detección', phase: 'Fase 4: Configuración y Pruebas', order: 402 },
    { name: 'Pruebas Funcionales con Humo/Calor por Dispositivo', category: 'detección', phase: 'Fase 4: Configuración y Pruebas', order: 403 },
    { name: 'Prueba de Activación de Sirenas y Luces Estroboscópicas', category: 'detección', phase: 'Fase 4: Configuración y Pruebas', order: 404 },
    { name: 'Certificación del Sistema (SEC/NFPA)', category: 'detección', phase: 'Fase 5: Certificación y Entrega', order: 501 },
    { name: 'Capacitación a Personal de Emergencia', category: 'detección', phase: 'Fase 5: Certificación y Entrega', order: 502 },
    { name: 'Entrega de Dossier de Calidad y Planos As-Built', category: 'detección', phase: 'Fase 5: Certificación y Entrega', order: 503 },
