...
export const initialSuggestedTasks: Omit<SuggestedTask, 'id'>[] = [
    // CCTV (100)
    { name: 'Planificación y Diseño del Sistema', category: 'cctv', order: 100 },
    { name: 'Levantamiento en Terreno y Relevamiento', category: 'cctv', order: 101 },
    { name: 'Aprobación de Ingeniería de Detalle', category: 'cctv', order: 102 },
    { name: 'Compra y Adquisición de Equipos (Cámaras, NVR, etc.)', category: 'cctv', order: 103 },
    { name: 'Canalización y Cableado Estructurado', category: 'cctv', order: 104 },
    { name: 'Instalación de Gabinete y Equipos Centrales (NVR/Servidor)', category: 'cctv', order: 105 },
    { name: 'Instalación y Montaje de Cámaras', category: 'cctv', order: 106 },
    { name: 'Configuración de Red y Direccionamiento IP', category: 'cctv', order: 107 },
    { name: 'Configuración del Software de Gestión de Video (VMS)', category: 'cctv', order: 108 },
    { name: 'Pruebas de Cobertura y Enfoque de Cámaras', category: 'cctv', order: 109 },
    { name: 'Puesta en Marcha y Pruebas de Integración', category: 'cctv', order: 110 },
    { name: 'Capacitación a Usuario Final', category: 'cctv', order: 111 },
    { name: 'Elaboración de Documentación y Planos As-Built', category: 'cctv', order: 112 },
    { name: 'Entrega y Recepción Final del Proyecto', category: 'cctv', order: 113 },
    // CCAA (Control de Acceso) (200)
    { name: 'Definición de Alcance y Puntos de Control', category: 'ccaa', order: 200 },
    { name: 'Diseño del Sistema y Topología', category: 'ccaa', order: 201 },
    { name: 'Adquisición de Equipos (Controladoras, lectoras, cerraduras)', category: 'ccaa', order: 202 },
    { name: 'Instalación de Canalizaciones', category: 'ccaa', order: 203 },
    { name: 'Instalación de Cerraduras Electromagnéticas/Pestillos', category: 'ccaa', order: 204 },
    { name: 'Instalación de Lectoras y Botones de Salida', category: 'ccaa', order: 205 },
    { name: 'Instalación de Panel de Control (Controladora)', category: 'ccaa', order: 206 },
    { name: 'Cableado de Puntos de Control a Controladora', category: 'ccaa', order: 207 },
    { name: 'Configuración de Software de Control de Acceso', category: 'ccaa', order: 208 },
    { name: 'Creación de Perfiles y Niveles de Acceso', category: 'ccaa', order: 209 },
    { name: 'Registro de Tarjetas/Credenciales de Usuarios', category: 'ccaa', order: 210 },
    { name: 'Pruebas de Apertura y Cierre de Puertas', category: 'ccaa', order: 211 },
    { name: 'Integración con otros sistemas (incendio, CCTV)', category: 'ccaa', order: 212 },
    { name: 'Marcha Blanca y Ajustes', category: 'ccaa', order: 213 },
    { name: 'Capacitación a Administradores y Usuarios', category: 'ccaa', order: 214 },
    // Detección de Incendios (300)
    { name: 'Análisis de Riesgos y Diseño según Normativa', category: 'detección', order: 300 },
    { name: 'Aprobación de Planos por Autoridad Competente', category: 'detección', order: 301 },
    { name: 'Adquisición de Paneles, Detectores y Sirenas', category: 'detección', order: 302 },
    { name: 'Trazado y Montaje de Tuberías EMT/PVC', category: 'detección', order: 303 },
    { name: 'Cableado de Lazo de Detección', category: 'detección', order: 304 },
    { name: 'Instalación del Panel Central', category: 'detección', order: 305 },
    { name: 'Instalación de Detectores de Humo/Temperatura', category: 'detección', order: 306 },
    { name: 'Instalación de Estaciones Manuales', category: 'detección', order: 307 },
    { name: 'Instalación de Sirenas con Estrobo', category: 'detección', order: 308 },
    { name: 'Programación de Zonas y Lógica de Activación', category: 'detección', order: 309 },
    { name: 'Pruebas de Continuidad y Aislación', category: 'detección', order: 310 },
    { name: 'Pruebas Funcionales con Humo/Calor', category: 'detección', order: 311 },
    { name: 'Certificación del Sistema (SEC/NFPA)', category: 'detección', order: 312 },
    // Extinción de Incendios (400)
    { name: 'Ingeniería y Cálculo Hidráulico', category: 'extinción', order: 400 },
    { name: 'Selección de Agente Extintor (Agua, gas, etc.)', category: 'extinción', order: 401 },
    { name: 'Adquisición de Rociadores, Válvulas y Tuberías', category: 'extinción', order: 402 },
    { name: 'Montaje de Red de Tuberías (Fitting)', category: 'extinción', order: 403 },
    { name: 'Instalación de Rociadores (Sprinklers)', category: 'extinción', order: 404 },
    { name: 'Instalación de Sala de Bombas', category: 'extinción', order: 405 },
    { name: 'Conexión a la Red de Agua', category: 'extinción', order: 406 },
    { name: 'Pruebas de Presión y Estanqueidad (Prueba Hidrostática)', category: 'extinción', order: 407 },
    { name: 'Puesta en Marcha del Sistema de Bombeo', category: 'extinción', order: 408 },
    { name: 'Pruebas de Flujo y Descarga', category: 'extinción', order: 409 },
    { name: 'Entrega de Planos y Dossier de Calidad', category: 'extinción', order: 410 },
    // Alarma (500)
    { name: 'Evaluación de Seguridad y Puntos Vulnerables', category: 'alarma', order: 500 },
    { name: 'Diseño del Sistema de Alarma (zonificación)', category: 'alarma', order: 501 },
    { name: 'Adquisición de Panel, Sensores y Teclados', category: 'alarma', order: 502 },
    { name: 'Cableado de Sensores de Movimiento y Magnéticos', category: 'alarma', order: 503 },
    { name: 'Instalación y Conexión del Panel Central', category: 'alarma', order: 504 },
    { name: 'Instalación de Sensores en Puertas y Ventanas', category: 'alarma', order: 505 },
    { name: 'Instalación de Sensores de Movimiento (PIR)', category: 'alarma', order: 506 },
    { name: 'Instalación de Teclado y Sirena', category: 'alarma', order: 507 },
    { name: 'Configuración de Zonas, Tiempos de Entrada/Salida', category: 'alarma', order: 508 },
    { name: 'Configuración de Comunicador (GPRS/IP) a Central de Monitoreo', category: 'alarma', order: 509 },
    { name: 'Pruebas de Activación de cada Zona', category: 'alarma', order: 510 },
    { name: 'Pruebas de Comunicación con Central', category: 'alarma', order: 511 },
    { name: 'Capacitación sobre Uso y Códigos', category: 'alarma', order: 512 },
];
